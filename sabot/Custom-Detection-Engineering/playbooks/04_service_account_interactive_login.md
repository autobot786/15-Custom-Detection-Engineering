# Playbook 04: Service Account Interactive Login

## One-page Summary
Service accounts should not log on interactively; disable, rotate secrets, deny interactive logon, migrate to managed identity.
